...
public class ForShowAccountRecruiter extends javax.swing.JFrame {

    DefaultComboBoxModel contactLists = new DefaultComboBoxModel();

    private int mainIndex;

    public ForShowAccountRecruiter() {
        initComponents();
    ...
    public ForShowAccountRecruiter(int mainIndex) {
...
//        this.setTitle("Personal Information |" + AccountHolders.getRecruiterByIndex(mainIndex).getFirstName());
    }

    public void setCurrentValues(int mainIndex) {

//        dateOfBirth.setText(AccountHolders.getRecruiterByIndex(mainIndex).getDateOfBirth());
//
//        if (("Male").equals(AccountHolders.getHunterByIndex(mainIndex).isSex())) {
//            jRadioButtonMale.setSelected(true);
//        } else if (("Male").equals(AccountHolders.getHunterByIndex(mainIndex).isSex())) {
//            jRadioButtonFemale.setSelected(true);
//        } else {
//            jRadioButtonPrefNotSay.setSelected(true);
//        }
//
//        String age = String.valueOf(AccountHolders.getRecruiterByIndex(mainIndex).getAge());
//        jLabelAge.setText("AGE: " + age);
//        jLabelName.setText("NAME: " + AccountHolders.getRecruiterByIndex(mainIndex).getFirstName() + " " + AccountHolders.getRecruiterByIndex(mainIndex).getLastName());
//        jLabelProfilePic.setIcon(AccountHolders.getRecruiterByIndex(mainIndex).getProfileImage());
//        PlaceOFBirth.setText(AccountHolders.getRecruiterByIndex(mainIndex).getPlaceOfBirth());
//        addressRegion.setText(AccountHolders.getRecruiterByIndex(mainIndex).getRegionLived());
//        addressProvince.setText(AccountHolders.getRecruiterByIndex(mainIndex).getProvinceLived());
//        addressCity.setText(AccountHolders.getRecruiterByIndex(mainIndex).getCityLived());
//        addressBarangay.setText(AccountHolders.getRecruiterByIndex(mainIndex).getBaranggayLived());
//        checkboxSameAddress.setSelected(AccountHolders.getRecruiterByIndex(mainIndex).isStateOfCheckBox());
//        addressRegion2.setText(AccountHolders.getRecruiterByIndex(mainIndex).getCregionLived());
//        addressProvince2.setText(AccountHolders.getRecruiterByIndex(mainIndex).getCprovinceLived());
//        addressCity2.setText(AccountHolders.getRecruiterByIndex(mainIndex).getCcityLived());
//        addressBarangay2.setText(AccountHolders.getRecruiterByIndex(mainIndex).getCbaranggayLived());
//
//        DefaultComboBoxModel cb = AccountHolders.getRecruiterByIndex(mainIndex).getContactLists();
...
//        }
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(jRadioButtonPrefNotSay);
        ...
        jLabelProfilePic.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelProfilePic.setText("Profile Pic");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(25, 25, 25)
                                .addComponent(dateOfBirth, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextFieldContactNumber, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jLabelAge, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
...
//        AccountHolders.getRecruiterByIndex(mainIndex).setAddInformationOfHunter(dateOfBirth.getText(), gender, addressRegion.getText(), addressProvince.getText(),
...
//                addressBarangay2.getText(), contactLists, stateOfCheckBox, jTextFieldContactNumber.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForShowAccountRecruiter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForShowAccountRecruiter().setVisible(true);
            }
        });
    }
